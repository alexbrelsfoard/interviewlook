$(document).ready(function() {
    ...
    $(vid).attr("src", $("a.video-link:first").attr("href"));

    // addClass playing to first video link
    $("a.video-link:first").addClass("playing");
    ...
    $("a.video-link").on("click", function(event) {
        ...
        if ($("a.video-link:first").hasClass("playing")) {
        ...
        if ($("a.video-link:last").hasClass("playing")) {
